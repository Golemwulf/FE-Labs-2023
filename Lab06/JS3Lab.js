 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
console.log("Question 3; Step 1: " + array1);
console.log("Question 3, Step 2: " + array1[2]);
console.log("Question 3; Step 3: " + array1[array1.length -1]);
array1.push(16, 3);
console.log("Updated Array 1: " + array1);
console.log("Question 3; Step 5: " + array1);
console.log("Question 3, Step 6: " + array1[array1.length -1]); 
// this results in a different outcome from the first three steps
...
console.log("Step 3: removed item2 from array " + myTodoList);
...
function reverse(x){
    if (typeof x === 'boolean'){
       ...
       return x.toString().split('').reverse('').reverse('').join('');
