...
//Answer: id, class, styles, css, properties, values
...
//Answer: Allows the user to dynamically add/remove items to the table
...
//Answer: mousedown, mouseup, mouseover, scroll, 
